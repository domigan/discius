...
export const STREAM_PROVIDER = 'https://discoveryprovider.audius5.prod-us-west-2.staked.cloud/v1'
...
export const get_trending_tracks_by_genre = async (genre) => {
    if (genre !== genres[0]){
        params['genre'] = genre
    }
...
export const get_track = async (track_id) => {
...
export const stream = async (track_id) => {
    const audio = new Audio(`${STREAM_PROVIDER}/tracks/${track_id}/stream?app_name=${APP_NAME}`)
    await audio.load()
